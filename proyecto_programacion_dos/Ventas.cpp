...
Venta::Venta(int id_venta, int id_pelicula, int id_sala, Fecha fecha_proyeccion, Fecha fecha_venta, int dni, int asiento, int entradas, int horarios, float total){
    setIdVenta(id_venta);
